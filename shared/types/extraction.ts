...
export interface Forderungen {
  ...
  // Legacy (optional, backward compat with existing DB records)
...
export interface Aktivum {
  ...
  // Extended: dual valuation + encumbrance breakdown (from real Gutachten)
  ...
  sicherungsrechte?: string; // Description of security rights (Absonderungs-/Aussonderungsberechtigter)
}
