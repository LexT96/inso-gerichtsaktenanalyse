...
const FIELD_LABELS: Record<string, string> = {
  ...
  'schuldner.telefon': 'Schuldner Telefon',
  'schuldner.mobiltelefon': 'Schuldner Mobiltelefon',
  'schuldner.email': 'Schuldner E-Mail',
  'schuldner.satzungssitz': 'Satzungssitz',
  'schuldner.verwaltungssitz': 'Verwaltungssitz',
  'schuldner.unternehmensgegenstand': 'Unternehmensgegenstand',
  'schuldner.geschaeftszweig': 'Geschäftszweig',
  'schuldner.stammkapital': 'Stammkapital',
  'schuldner.geschaeftsfuehrer': 'Geschäftsführer',
  'schuldner.prokurist': 'Prokurist',
  'schuldner.gruendungsdatum': 'Gründungsdatum',
  'schuldner.hr_eintragung_datum': 'HR-Eintragung',
  'schuldner.groessenklasse_hgb': 'Größenklasse HGB',
  'schuldner.dundo_versicherung': 'D&O Versicherung',
  'schuldner.arbeitnehmer_anzahl': 'Arbeitnehmer',
  'schuldner.betriebsrat': 'Betriebsrat',
  'schuldner.finanzamt': 'Finanzamt',
  'schuldner.steuernummer': 'Steuer-Nr.',
  'schuldner.ust_id': 'USt-ID',
  'schuldner.wirtschaftsjahr': 'Wirtschaftsjahr',
  'schuldner.ust_versteuerung': 'USt-Versteuerung',
  'schuldner.steuerliche_organschaft': 'Steuerliche Organschaft',
  'schuldner.letzter_jahresabschluss': 'Letzter Jahresabschluss',
  'schuldner.sozialversicherungstraeger': 'SV-Träger',
  'schuldner.steuerberater': 'Steuerberater',
  'schuldner.bankverbindungen': 'Bankverbindungen',
  'schuldner.insolvenzsonderkonto': 'Insolvenzsonderkonto',
  'schuldner.ehegatte.name': 'Ehegatte Name',
  'schuldner.ehegatte.geburtsdatum': 'Ehegatte Geburtsdatum',
  'schuldner.ehegatte.gemeinsames_eigentum': 'Gemeinsames Eigentum',
  'schuldner.beschaeftigung.arbeitgeber': 'Arbeitgeber',
  'schuldner.beschaeftigung.arbeitgeber_adresse': 'Arbeitgeber Adresse',
  'schuldner.beschaeftigung.nettoeinkommen': 'Nettoeinkommen',
  'schuldner.beschaeftigung.beschaeftigt_seit': 'Beschäftigt seit',
  'schuldner.beschaeftigung.art': 'Beschäftigungsart',
  'schuldner.pfaendungsberechnung.nettoeinkommen': 'Pfändung Nettoeinkommen',
  'schuldner.pfaendungsberechnung.unterhaltspflichten': 'Unterhaltspflichten',
  'schuldner.pfaendungsberechnung.pfaendbarer_betrag': 'Pfändbarer Betrag',
