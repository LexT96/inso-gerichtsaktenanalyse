...
WICHTIG — zustellungsdatum_schuldner: Das Zustellungsdatum stammt AUSSCHLIESSLICH aus der Postzustellungsurkunde (PZU, "Zustellungsurkunde"). Eine PZU besteht typischerweise aus ZWEI aufeinanderfolgenden Seiten (Vorder- und Rückseite). Welches Feld das Zustellungsdatum enthält, hängt von der Zustellungsart ab:
- Direkte Übergabe an den Adressaten: Datum steht in Feld 1.6 "Datum" auf der VORDERSEITE — 6 handgeschriebene Ziffern in einzelnen Kästchen, Format TT MM JJ.
- Ersatzzustellung (Felder 9 "zu übergeben versucht", 10 "Geschäftsraum" oder 11 "Niederlegungsstelle" angekreuzt): Datum steht in Feld 13.1 "Datum" auf der RÜCKSEITE — gleiches Kästchen-Format. Begleitfelder auf der Rückseite: 13.2 Uhrzeit, 13.4 "Postunternehmen/Behörde" (z.B. "Deutsche Post AG, Zustellstützpunkt"), 13.5 Name des Zustellers (handschriftlich, z.B. "Kassem, Ahmed").
NIEMALS verwenden: Eingangs-/Ausgangsstempel des Gerichts oben auf der PZU (z.B. "18. Aug. 2025"), Datum des zugestellten Schriftstücks (Feld 1.5), Beschluss-/Antragsdatum, oder andere Datumsangaben außerhalb der Felder 1.6 / 13.1. Lies die handgeschriebenen Ziffern in den Kästchen sorgfältig — verwechsle nicht "1 4" mit "0 4" oder "1 8" mit "0 8". Beispiel: Kästchen "1 4 0 8 2 5" → 14.08.2025. Wenn die Kästchen leer oder unleserlich sind: zustellungsdatum_schuldner = null (NICHT raten, NICHT auf andere Daten ausweichen).
